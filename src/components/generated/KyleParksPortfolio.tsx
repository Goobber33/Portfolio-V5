...
const technologies = [{
  ...
  color: '#61DAFB',
  category: 'Frontend',
  mpid: "d76d28a3-dbfd-4ca9-aec1-c4f226abb7c2"
}, {
  name: 'TypeScript',
  icon: '📘',
  color: '#3178C6',
  category: 'Frontend',
  mpid: "3e27e56c-58fe-4e48-9841-f4ea06cb0633"
}, {
  name: 'JavaScript',
  icon: '🟨',
  color: '#F7DF1E',
  category: 'Frontend',
  mpid: "a2a976d9-1efa-43af-8483-cb16836798fa"
}, {
  name: 'HTML',
  icon: '🌐',
  color: '#E34F26',
  category: 'Frontend',
  mpid: "e92840e6-1f9f-48b1-acd0-a82d462b519e"
}, {
  name: 'CSS',
  icon: '🎨',
  color: '#1572B6',
  category: 'Frontend',
  mpid: "586db95d-1b7d-49ca-aa16-e68abbb84d58"
}, {
  name: 'Tailwind',
  icon: '💨',
  color: '#06B6D4',
  category: 'Frontend',
  mpid: "7623913b-9053-4022-8a69-3bf1532abba6"
}, {
  name: 'Next.js',
  icon: '▲',
  color: '#000000',
  category: 'Frontend',
  mpid: "6b8ca58e-5599-4230-86a8-60248cd6a044"
}, {
  name: 'Node.js',
  icon: '🟢',
  color: '#339933',
  category: 'Backend',
  mpid: "f160f426-44a5-4918-9042-829a3fc45fdf"
}, {
  name: 'Express',
  icon: '🚂',
  color: '#000000',
  category: 'Backend',
  mpid: "587a77e2-79c4-4f37-8b3f-296b738f68ee"
}, {
  name: 'GraphQL',
  icon: '◆',
  color: '#E10098',
  category: 'Backend',
  mpid: "78257980-4e75-4bb4-80c3-416493669be7"
}, {
  name: 'REST API',
  icon: '🔗',
  color: '#8A4FFF',
  category: 'Backend',
  mpid: "f83d4a14-e2b8-4fd9-b5b2-45e4681a9a10"
}, {
  name: 'MongoDB',
  icon: '🍃',
  color: '#47A248',
  category: 'Database',
  mpid: "ac7f4026-ba2e-4ff6-8e9f-d11d34b5d6fb"
}, {
  name: 'PostgreSQL',
  icon: '🐘',
  color: '#4169E1',
  category: 'Database',
  mpid: "ffec7fde-4ca5-47c0-aac1-129d49901326"
}, {
  name: 'Git',
  icon: '📦',
  color: '#F05032',
  category: 'Tools',
  mpid: "d7a13f93-df48-4114-b990-413bee35d9d8"
}, {
  name: 'Docker',
  icon: '🐳',
  color: '#2496ED',
  category: 'Tools',
  mpid: "b371864d-e09d-4a5e-8541-9a67370a8cb0"
}, {
  name: 'AWS',
  icon: '☁️',
  color: '#FF9900',
  category: 'Tools',
  mpid: "1c0f4eb0-83ba-4e64-bbae-1cb5dc014b9e"
}, {
  name: 'Webpack',
  icon: '📦',
  color: '#8DD6F9',
  category: 'Tools',
  mpid: "63dd590a-ff42-4b41-9e4e-6efce1680886"
}, {
  name: 'Vite',
  icon: '⚡',
  color: '#646CFF',
  category: 'Tools',
  mpid: "3fb0dbf2-83e7-4205-82b6-9b3368672923"
}, {
  name: 'Jest',
  icon: '🃏',
  color: '#C21325',
  category: 'Testing',
  mpid: "08b9e3b1-55c7-4218-861b-4f5963eba818"
}, {
  name: 'Testing Library',
  icon: '✅',
  color: '#4CAF50',
  category: 'Testing',
  mpid: "af3ed766-9a12-4a83-a046-71ed0bf4b7ab"
}] as any[];
const skillCategories = [{
  ...
  mpid: "39e29e9b-343a-4035-aee9-263de72b5e5a"
}, {
  name: 'Backend Development',
  icon: '⚙️',
  color: '#9D5FFF',
  skills: technologies.filter(t => t.category === 'Backend'),
  mpid: "8c0c3db6-865b-49ca-a003-a408ba3f499a"
}, {
  name: 'Database & Storage',
  icon: '💾',
  color: '#C3BEF0',
  skills: technologies.filter(t => t.category === 'Database'),
  mpid: "55b1fd5a-6cd7-419d-b317-a2ffae6dd277"
}, {
  name: 'Tools & DevOps',
  icon: '🛠️',
  color: '#8A4FFF',
  skills: technologies.filter(t => t.category === 'Tools'),
  mpid: "b3c99f8a-21ee-4cf7-990a-f2858ab83e86"
}, {
  name: 'Testing & Quality',
  icon: '✓',
  color: '#9D5FFF',
  skills: technologies.filter(t => t.category === 'Testing'),
  mpid: "53d72be0-8b11-4b1a-8613-c7b4e7324ace"
}] as any[];
const projects = [{
...
const education = [{
  ...
  color: '#8A4FFF',
  mpid: "91a97b70-eea7-4fdd-9a45-c70b3cb67938"
}, {
  ...
  color: '#C3BEF0',
  mpid: "67f1745c-fa00-495c-9749-9ac56c170c6d"
}] as any[];
...
export const KyleParksPortfolio = (props: KyleParksPortfolioProps) => {
  ...
  // @return
  return <SortableContainer dndKitId="55daa253-508f-4db9-b306-c6eef1a99c7e" containerType="regular" prevTag="div" className="min-h-screen w-full bg-white overflow-x-hidden" data-magicpath-id="2" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      {/* Enhanced Navigation */}
      <SortableContainer dndKitId="e03ff97a-c06e-4c38-8425-6459a682495f" containerType="regular" prevTag="motion.nav" className="fixed top-0 left-0 right-0 z-40 border-b border-[#E5ECF4]/80 backdrop-blur-xl shadow-sm" style={{
      ...
      ease: [0.22, 1, 0.36, 1]
        ...
        <SortableContainer dndKitId="59f29e00-8daf-4412-83e2-4af2874ecf66" containerType="regular" prevTag="div" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-magicpath-id="5" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="d66f257c-c8ad-4ac0-969a-ae1c2b82252e" containerType="regular" prevTag="div" className="flex items-center justify-between h-16" data-magicpath-id="6" data-magicpath-path="KyleParksPortfolio.tsx">
            <SortableContainer dndKitId="9c75c8f1-d02a-4cbb-bbd3-ddc3c2590b28" containerType="regular" prevTag="motion.div" className="text-2xl font-bold cursor-pointer relative group" whileHover={{
            scale: 1.1,
            rotate: 5
          }} whileTap={{
            scale: 0.95
            ...
            <SortableContainer dndKitId="65ceaa90-1f3e-41e9-b96e-957de4464b51" containerType="regular" prevTag="motion.button" className="md:hidden text-gray-700 p-2 rounded-lg hover:bg-[#EFFFFA] transition-colors" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} whileTap={{
            scale: 0.95
          }} data-magicpath-id="15" data-magicpath-path="KyleParksPortfolio.tsx">
              <SortableContainer dndKitId="bc68716a-d986-4678-b6f5-d6c1ef8f9806" containerType="regular" prevTag="motion.div" animate={{
        ...
        {mobileMenuOpen && <SortableContainer dndKitId="caee42c9-54c4-41e8-8d7d-1d3edd2c7f20" containerType="regular" prevTag="motion.div" initial={{
        opacity: 0,
        height: 0
      }} animate={{
        opacity: 1,
      ...
      <SortableContainer dndKitId="024e7448-090d-4a58-b1d7-8afab6457bb4" containerType="regular" prevTag="section" id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16" data-magicpath-id="22" data-magicpath-path="KyleParksPortfolio.tsx">
        ...
        <SortableContainer dndKitId="a601db69-a818-41bc-aedc-d3848ea1ea7a" containerType="regular" prevTag="motion.div" className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center" style={{
        y: heroY,
        opacity: heroOpacity,
        scale: heroScale
      }} data-magicpath-id="27" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="532b158c-7d67-47cd-9ba2-64a153cfc35a" containerType="regular" prevTag="motion.div" variants={containerVariants} initial="hidden" animate="visible" data-magicpath-id="28" data-magicpath-path="KyleParksPortfolio.tsx">
            ...
            <SortableContainer dndKitId="3e1887b0-208a-47f1-993e-f5df4df4a85c" containerType="regular" prevTag="motion.div" variants={itemVariants} data-magicpath-id="30" data-magicpath-path="KyleParksPortfolio.tsx">
            ...
            <SortableContainer dndKitId="4f164c29-089b-4b9c-b22f-af0c26a42276" containerType="collection" prevTag="motion.div" variants={itemVariants} className="flex items-center justify-center gap-6 mb-20" data-magicpath-id="33" data-magicpath-path="KyleParksPortfolio.tsx">
              {[{
              icon: Github,
              href: 'https://github.com',
              label: 'GitHub',
              mpid: "6c54893e-501d-4670-bc3b-418d3b786c6a"
            }, {
              icon: Linkedin,
              href: 'https://linkedin.com',
              label: 'LinkedIn',
              mpid: "b7daac7a-1ad7-4aa3-b0e0-eacff543c5ec"
            }, {
              icon: Mail,
              href: 'mailto:kyle@example.com',
              label: 'Email',
              mpid: "386a58c0-198e-4d14-831a-3874a7ecc184"
            }].map(({
              icon: Icon,
              href,
              label
            ...
            <SortableContainer dndKitId="307bf114-eec0-4ce1-afb8-b416c4608953" containerType="regular" prevTag="motion.button" variants={itemVariants} onClick={() => scrollToSection('about')} className="text-[#8A4FFF] flex flex-col items-center gap-3 mx-auto group" data-magicpath-id="36" data-magicpath-path="KyleParksPortfolio.tsx">
              ...
              <SortableContainer dndKitId="a7d22677-c181-4e73-9d39-b530e6d648e0" containerType="regular" prevTag="motion.div" animate={{
              y: [0, 10, 0]
            }} transition={{
              duration: 1.5,
              repeat: Infinity,
      ...
      <SortableContainer dndKitId="76c4395e-5417-4dd0-a4ab-a595bfd50e3a" containerType="regular" prevTag="section" id="about" className="py-32 bg-white relative" data-magicpath-id="40" data-magicpath-path="KyleParksPortfolio.tsx">
        <SortableContainer dndKitId="d54907d8-441b-4f51-84a4-27f045fb530d" containerType="regular" prevTag="div" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" data-magicpath-id="41" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="18444121-1e2d-4195-8119-9d441e6747fa" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="e37a20e7-a493-44ed-8b0d-a0946ab0f61c" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-20" initial={{
            opacity: 0,
            x: -100
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="a1cca6e0-2622-46f6-a254-307d202dccbb" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.3
            }} transition={{
              duration: 0.6
            ...
            <SortableContainer dndKitId="8e51b20c-1a61-4f1c-8759-13edaae4c3e1" containerType="regular" prevTag="div" className="grid md:grid-cols-2 gap-16 items-center" data-magicpath-id="47" data-magicpath-path="KyleParksPortfolio.tsx">
              <SortableContainer dndKitId="3f66de1b-315e-4e0d-90cc-d3e8b091b952" containerType="regular" prevTag="motion.div" initial={{
              opacity: 0,
              x: -100
            }} whileInView={{
              opacity: 1,
              ...
              once: true
                ...
                <SortableContainer dndKitId="00792aa8-0286-4e29-a95c-38c71ef8e6d5" containerType="collection" prevTag="motion.div" className="grid grid-cols-3 gap-4 pt-6" initial={{
                opacity: 0,
                y: 50
              }} whileInView={{
                opacity: 1,
                ...
                once: true
                  ...
                  value: '15+',
                  icon: Briefcase,
                  mpid: "b6947095-1dce-4d6e-ba4d-745f098c32b9"
                }, {
                  label: 'Skills',
                  value: '24+',
                  icon: Code,
                  mpid: "b330102b-9c4d-4f20-9560-060d5575da31"
                }, {
                  label: 'Certifications',
                  value: '3',
                  icon: Award,
                  mpid: "55753514-8ae3-41ba-a709-e1b4419be72e"
                }].map(({
                  label,
                  value,
                  icon: Icon
              ...
              <SortableContainer dndKitId="fb7f0236-612d-40ac-9939-fb4217c30b4a" containerType="regular" prevTag="motion.div" className="relative" initial={{
              opacity: 0,
              scale: 0.8,
              rotate: -5
            }} whileInView={{
              ...
              once: true
                ...
                <SortableContainer dndKitId="dc1d7958-0ac3-453b-9bf6-8a01ea358f60" containerType="regular" prevTag="motion.div" className="w-full h-96 md:h-[500px] rounded-3xl bg-gradient-to-br from-[#8A4FFF] via-[#9D5FFF] to-[#C3BEF0] p-1.5 shadow-2xl" whileHover={{
                scale: 1.05,
                rotate: 2
              }} transition={{
                duration: 0.3
              }} data-magicpath-id="58" data-magicpath-path="KyleParksPortfolio.tsx">
                  <SortableContainer dndKitId="24473bc3-1ba2-4984-91fa-d0e5d33814b9" containerType="regular" prevTag="div" className="w-full h-full bg-white rounded-[22px] overflow-hidden" data-magicpath-id="59" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      <SortableContainer dndKitId="28ea4606-d2aa-4388-8bb5-c53b5ab49530" containerType="regular" prevTag="section" id="education" className="py-32 bg-gradient-to-br from-[#EFFFFA] via-white to-[#E5ECF4] relative overflow-hidden" data-magicpath-id="63" data-magicpath-path="KyleParksPortfolio.tsx">
        <FloatingOrb delay={0} duration={25} size="medium" color="#C3BEF0" data-magicpath-id="64" data-magicpath-path="KyleParksPortfolio.tsx" />

        <SortableContainer dndKitId="219e12d5-63a5-4716-809f-01dc5847ee3a" containerType="regular" prevTag="div" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" data-magicpath-id="65" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="af3e558c-2f6e-4f91-a66d-58d2a2a414d5" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="de831447-f542-473e-b8f9-e30453130097" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-20" initial={{
            opacity: 0,
            x: -100
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="26a51fa8-a16a-46a5-b124-76abf0c7c5c7" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.3
            }} transition={{
              duration: 0.6
            ...
            <SortableContainer dndKitId="d1a00528-9d9b-4507-913f-329c915ff1f8" containerType="collection" prevTag="div" className="space-y-8" data-magicpath-id="71" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      <SortableContainer dndKitId="b602a259-2a06-4320-8e0e-2eafc53b9259" containerType="regular" prevTag="section" id="skills" className="py-32 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden" data-magicpath-id="78" data-magicpath-path="KyleParksPortfolio.tsx">
        <SortableContainer dndKitId="cf451d5f-5a4c-4c79-92a5-b813ce2330ec" containerType="regular" prevTag="div" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-magicpath-id="79" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="e5eb0d40-fb4b-41d1-9c92-952f1a4ee6bf" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="7a1625d0-ed02-4bef-8f34-120687e0120f" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-6 justify-center" initial={{
            opacity: 0,
            y: -50
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="ab740af5-09ac-4a97-a0c0-56369b7ae9f4" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.1
            }} transition={{
              duration: 0.6
            ...
            <SortableContainer dndKitId="27a323ef-184c-48ad-b418-9c0711a9ae05" containerType="regular" prevTag="div" className="relative" data-magicpath-id="86" data-magicpath-path="KyleParksPortfolio.tsx">
              {/* Gradient Overlays */}
              ...
              {/* Marquee Container */}
              <SortableContainer dndKitId="e881d497-3033-42b0-93f2-9aca659ec80b" containerType="regular" prevTag="div" className="flex overflow-hidden py-8" data-magicpath-id="89" data-magicpath-path="KyleParksPortfolio.tsx">
                {/* First set of technologies */}
                <SortableContainer dndKitId="4cd2e927-02a2-48ef-a86e-4d0b73d48aec" containerType="collection" prevTag="motion.div" className="flex gap-8 shrink-0" animate={{
                x: [0, -1920]
              }} transition={{
                duration: 40,
                repeat: Infinity,
                ease: "linear"
                  ...
                  scale: 1.15,
                  y: -8
                }} className="group relative bg-white rounded-2xl p-8 border border-gray-200 hover:border-[#8A4FFF]/40 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-xl min-w-[180px]" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-id="91" data-magicpath-path="KyleParksPortfolio.tsx">
                      ...
                      {/* Tech content */}
                      <div className="flex flex-col items-center justify-center gap-4 relative" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-id="93" data-magicpath-path="KyleParksPortfolio.tsx">
                        <span className="text-5xl transition-transform duration-300 group-hover:scale-125" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-field="icon:unknown" data-magicpath-id="94" data-magicpath-path="KyleParksPortfolio.tsx">
                          {tech.icon}
                        </span>
                        <span className="text-base font-semibold text-gray-800 text-center group-hover:text-[#8A4FFF] transition-colors duration-300" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-field="name:unknown" data-magicpath-id="95" data-magicpath-path="KyleParksPortfolio.tsx">
                          {tech.name}
                        </span>
                      </div>
                ...
                <SortableContainer dndKitId="7fe739a1-99fc-4fc7-9098-5a4e20b2aacf" containerType="collection" prevTag="motion.div" className="flex gap-8 shrink-0" animate={{
                x: [0, -1920]
              }} transition={{
                duration: 40,
                repeat: Infinity,
                ease: "linear"
                  ...
                  scale: 1.15,
                  y: -8
                }} className="group relative bg-white rounded-2xl p-8 border border-gray-200 hover:border-[#8A4FFF]/40 transition-all duration-300 cursor-pointer shadow-sm hover:shadow-xl min-w-[180px]" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-id="98" data-magicpath-path="KyleParksPortfolio.tsx">
                      {/* Hover gradient background */}
                      ...
                      {/* Tech content */}
                      <div className="flex flex-col items-center justify-center gap-4 relative" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-id="100" data-magicpath-path="KyleParksPortfolio.tsx">
                        <span className="text-5xl transition-transform duration-300 group-hover:scale-125" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-field="icon:unknown" data-magicpath-id="101" data-magicpath-path="KyleParksPortfolio.tsx">
                          {tech.icon}
                        </span>
                        <span className="text-base font-semibold text-gray-800 text-center group-hover:text-[#8A4FFF] transition-colors duration-300" data-magicpath-uuid={(tech as any)["mpid"] ?? "unsafe"} data-magicpath-field="name:unknown" data-magicpath-id="102" data-magicpath-path="KyleParksPortfolio.tsx">
                          {tech.name}
                        </span>
                      </div>
            ...
            <SortableContainer dndKitId="fcf23eee-e704-439b-8d03-c2878fe575ce" containerType="regular" prevTag="motion.div" initial={{
            opacity: 0,
            y: 20
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="5120f8c2-5460-41a9-917f-693a0fc31961" containerType="regular" prevTag="div" className="inline-flex items-center gap-4 px-8 py-4 bg-white rounded-xl border border-gray-200 shadow-sm" data-magicpath-id="105" data-magicpath-path="KyleParksPortfolio.tsx">
                <SortableContainer dndKitId="17774863-d3ab-49ad-9122-125879ec3761" containerType="regular" prevTag="div" className="flex items-center justify-center w-10 h-10 rounded-lg bg-gradient-to-br from-[#8A4FFF] to-[#C3BEF0]" data-magicpath-id="106" data-magicpath-path="KyleParksPortfolio.tsx">
                  <Sparkles className="text-white" size={20} />
                </SortableContainer>
                <SortableContainer dndKitId="a3e99556-0f45-4010-b9bf-ae7c634733ab" containerType="regular" prevTag="div" className="text-left" data-magicpath-id="107" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      <SortableContainer dndKitId="aa957bd3-e015-4cd3-895b-5defcb2c3582" containerType="regular" prevTag="section" id="projects" className="py-32 bg-gradient-to-br from-[#E5ECF4] via-white to-[#EFFFFA] relative overflow-hidden" data-magicpath-id="110" data-magicpath-path="KyleParksPortfolio.tsx">
        <FloatingOrb delay={5} duration={25} size="large" color="#8A4FFF" data-magicpath-id="111" data-magicpath-path="KyleParksPortfolio.tsx" />

        <SortableContainer dndKitId="0ef6f2eb-f78d-46f8-a04e-dc1be7a26467" containerType="regular" prevTag="div" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" data-magicpath-id="112" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="3c56ebec-8cb5-4eb7-a825-1703fe174fb5" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="7240a8ca-62ed-4cda-a9e9-6b2a0d062d3c" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-20" initial={{
            opacity: 0,
            x: -100
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="36727874-764c-48ee-9464-662fcc72e50e" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.3
            }} transition={{
              duration: 0.6
            ...
            <SortableContainer dndKitId="59d12307-f64a-4ed3-9dcb-d6c08604be85" containerType="collection" prevTag="div" className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16" data-magicpath-id="118" data-magicpath-path="KyleParksPortfolio.tsx">
            ...
            <SortableContainer dndKitId="3e86a1d6-fcfd-4a05-a61b-27054e8a02a4" containerType="regular" prevTag="motion.div" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
      ...
      <SortableContainer dndKitId="67e6850a-89d1-474b-bcb1-50d97dd3e8b3" containerType="regular" prevTag="section" id="contact" className="py-32 bg-gradient-to-br from-[#8A4FFF] via-[#9D5FFF] to-[#C3BEF0] relative overflow-hidden" data-magicpath-id="133" data-magicpath-path="KyleParksPortfolio.tsx">
        <FloatingOrb delay={0} duration={20} size="large" color="#FFFFFF" data-magicpath-id="134" data-magicpath-path="KyleParksPortfolio.tsx" />

        <SortableContainer dndKitId="1694bc69-0624-4385-ac00-0c727fcba987" containerType="regular" prevTag="div" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10" data-magicpath-id="135" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="092a4763-9659-4a7e-b2a6-53dec67008da" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          y: 80
        }} whileInView={{
          opacity: 1,
          ...
          once: true
            ...
            <SortableContainer dndKitId="80f56c78-36ac-4137-877e-cba7b40c00af" containerType="regular" prevTag="motion.div" className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-20" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            {/* Footer content */}
            <SortableContainer dndKitId="a3d6b3cf-55d4-4f0d-83db-d103a884621b" containerType="regular" prevTag="motion.div" className="pt-10 border-t border-white/20" initial={{
            opacity: 0
          }} whileInView={{
            opacity: 1
          }} transition={{
            ...
            once: true
              ...
              <SortableContainer dndKitId="ecd345a2-a7cd-47cf-91e5-cfd1f2c19a98" containerType="regular" prevTag="div" className="flex flex-col md:flex-row items-center justify-between gap-6" data-magicpath-id="145" data-magicpath-path="KyleParksPortfolio.tsx">
                ...
                <SortableContainer dndKitId="cc3c2499-680c-47d6-9e1e-05b66371df48" containerType="collection" prevTag="div" className="flex items-center gap-5" data-magicpath-id="147" data-magicpath-path="KyleParksPortfolio.tsx">
                  {[{
                  icon: Github,
                  href: 'https://github.com',
                  label: 'GitHub',
                  mpid: "514e37a8-4e2c-4b48-bd5d-e26bc740f991"
                }, {
                  icon: Linkedin,
                  href: 'https://linkedin.com',
                  label: 'LinkedIn',
                  mpid: "de4aaa69-c3f1-4c66-b0e4-5ed9fc368d07"
                }, {
                  icon: Mail,
                  href: 'mailto:kyle@example.com',
                  label: 'Email',
                  mpid: "e8aa00e3-6330-4d50-bf40-eb3466096958"
                }].map(({
                  icon: Icon,
                  href,
                  label
