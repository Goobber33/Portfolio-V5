...
const education = [{
  ...
  color: '#8A4FFF',
  mpid: "3d0a1524-9063-4231-89cc-125ce978fe05"
}, {
  ...
  color: '#C3BEF0',
  mpid: "a31a0fea-6412-4369-9ff0-987e876f24bb"
}] as any[];
...
export const KyleParksPortfolio = (props: KyleParksPortfolioProps) => {
  ...
  // @return
  return <SortableContainer dndKitId="0826df03-a696-4b27-bbbd-f2109a6b7473" containerType="regular" prevTag="div" className="min-h-screen w-full bg-white overflow-x-hidden" data-magicpath-id="2" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      {/* Enhanced Navigation */}
      <SortableContainer dndKitId="bb5d49f7-52a6-42a2-9d9e-e0f209d8f400" containerType="regular" prevTag="motion.nav" className="fixed top-0 left-0 right-0 z-40 border-b border-[#E5ECF4]/80 backdrop-blur-xl shadow-sm" style={{
      ...
      ease: [0.22, 1, 0.36, 1]
        ...
        <SortableContainer dndKitId="aca89fd1-0876-4d01-98d5-74fd3de0540c" containerType="regular" prevTag="div" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-magicpath-id="5" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="444d37a2-f8f9-4365-ba33-1933d395b6e8" containerType="regular" prevTag="div" className="flex items-center justify-between h-16" data-magicpath-id="6" data-magicpath-path="KyleParksPortfolio.tsx">
            <SortableContainer dndKitId="002b3842-3289-4c47-85f2-6033f3beaa3f" containerType="regular" prevTag="motion.div" className="text-2xl font-bold cursor-pointer relative group" whileHover={{
            scale: 1.1,
            rotate: 5
          }} whileTap={{
            scale: 0.95
            ...
            <SortableContainer dndKitId="22516e04-a342-48a5-89e2-b4f10a1b45ee" containerType="regular" prevTag="motion.button" className="md:hidden text-gray-700 p-2 rounded-lg hover:bg-[#EFFFFA] transition-colors" onClick={() => setMobileMenuOpen(!mobileMenuOpen)} whileTap={{
            scale: 0.95
          }} data-magicpath-id="15" data-magicpath-path="KyleParksPortfolio.tsx">
              <SortableContainer dndKitId="e44c11d4-0bbf-434f-b02b-6a0e58afa29b" containerType="regular" prevTag="motion.div" animate={{
        ...
        {mobileMenuOpen && <SortableContainer dndKitId="b096e8cd-1963-47cd-9544-cf10016bcb3b" containerType="regular" prevTag="motion.div" initial={{
        opacity: 0,
        height: 0
      }} animate={{
        opacity: 1,
      ...
      <SortableContainer dndKitId="75ef34b9-1525-45cd-b7ac-01b13b59abe6" containerType="regular" prevTag="section" id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16" data-magicpath-id="22" data-magicpath-path="KyleParksPortfolio.tsx">
        ...
        <SortableContainer dndKitId="c46ee4bb-6fc9-47fe-99b2-57edfadd37b2" containerType="regular" prevTag="motion.div" className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center" style={{
        y: heroY,
        opacity: heroOpacity,
        scale: heroScale
      }} data-magicpath-id="27" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="df751683-b6af-4c3a-a38f-ffd61d056df0" containerType="regular" prevTag="motion.div" variants={containerVariants} initial="hidden" animate="visible" data-magicpath-id="28" data-magicpath-path="KyleParksPortfolio.tsx">
            ...
            <SortableContainer dndKitId="54eff9a9-fff0-4f85-9afa-015a3ad22edb" containerType="regular" prevTag="motion.div" variants={itemVariants} data-magicpath-id="30" data-magicpath-path="KyleParksPortfolio.tsx">
            ...
            <SortableContainer dndKitId="01dbc801-d2ff-499d-9063-40193793c4f0" containerType="collection" prevTag="motion.div" variants={itemVariants} className="flex items-center justify-center gap-6 mb-20" data-magicpath-id="33" data-magicpath-path="KyleParksPortfolio.tsx">
              {[{
              icon: Github,
              href: 'https://github.com',
              label: 'GitHub',
              mpid: "9ee2bf9f-8728-450e-a1f4-ac55e6a24e5c"
            }, {
              icon: Linkedin,
              href: 'https://linkedin.com',
              label: 'LinkedIn',
              mpid: "bc026825-c3fc-46b9-ae21-f619c88fcff8"
            }, {
              icon: Mail,
              href: 'mailto:kyle@example.com',
              label: 'Email',
              mpid: "9e10cc18-1ad0-4136-9f47-b67fd2045ed7"
            }].map(({
              icon: Icon,
              href,
              label
            ...
            <SortableContainer dndKitId="c4449ff0-7107-499a-84d5-4ee3b0a9b19f" containerType="regular" prevTag="motion.button" variants={itemVariants} onClick={() => scrollToSection('about')} className="text-[#8A4FFF] flex flex-col items-center gap-3 mx-auto group" data-magicpath-id="36" data-magicpath-path="KyleParksPortfolio.tsx">
              ...
              <SortableContainer dndKitId="408ad348-3a9f-4eaf-a662-ccdff8e6c863" containerType="regular" prevTag="motion.div" animate={{
              y: [0, 10, 0]
            }} transition={{
              duration: 1.5,
              repeat: Infinity,
      ...
      <SortableContainer dndKitId="2302dc31-4525-4d46-b01d-248f324c12c2" containerType="regular" prevTag="section" id="about" className="py-32 bg-white relative" data-magicpath-id="40" data-magicpath-path="KyleParksPortfolio.tsx">
        <SortableContainer dndKitId="044df542-a96c-47f9-98cd-ffabd2c5c0eb" containerType="regular" prevTag="div" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" data-magicpath-id="41" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="9c60261f-2f2c-4350-9fee-84a36449f7b4" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="b014b57b-dcb7-4260-bb63-03d059b58b36" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-20" initial={{
            opacity: 0,
            x: -100
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="aca5a50a-fdb7-474e-841d-007453b29f32" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.3
            }} transition={{
              duration: 0.6
            ...
            <SortableContainer dndKitId="3470d305-e784-4733-afc5-e83a64d1a6cc" containerType="regular" prevTag="div" className="grid md:grid-cols-2 gap-16 items-center" data-magicpath-id="47" data-magicpath-path="KyleParksPortfolio.tsx">
              <SortableContainer dndKitId="7c49e2ae-a1b8-49f8-8af9-033738ffa585" containerType="regular" prevTag="motion.div" initial={{
              opacity: 0,
              x: -100
            }} whileInView={{
              opacity: 1,
              ...
              once: true
                ...
                <SortableContainer dndKitId="ae606153-d23a-452b-9388-9c2c71541b24" containerType="collection" prevTag="motion.div" className="grid grid-cols-3 gap-4 pt-6" initial={{
                opacity: 0,
                y: 50
              }} whileInView={{
                opacity: 1,
                ...
                once: true
                  ...
                  value: '15+',
                  icon: Briefcase,
                  mpid: "863d4c68-05d6-4ac5-a66d-4a8910ba410d"
                }, {
                  label: 'Skills',
                  value: '24+',
                  icon: Code,
                  mpid: "6fdd1663-3528-4095-b3fa-4ff6ebaa86a6"
                }, {
                  label: 'Certifications',
                  value: '3',
                  icon: Award,
                  mpid: "19573d69-1ed3-4b84-b9e2-5c9400c60cbe"
                }].map(({
                  label,
                  value,
                  icon: Icon
              ...
              <SortableContainer dndKitId="a76a4308-6b55-40ca-9643-1f3c55553786" containerType="regular" prevTag="motion.div" className="relative" initial={{
              opacity: 0,
              scale: 0.8,
              rotate: -5
            }} whileInView={{
              ...
              once: true
                ...
                <SortableContainer dndKitId="fa211149-6667-4a59-a105-8a3a0c66d5ac" containerType="regular" prevTag="motion.div" className="w-full h-96 md:h-[500px] rounded-3xl bg-gradient-to-br from-[#8A4FFF] via-[#9D5FFF] to-[#C3BEF0] p-1.5 shadow-2xl" whileHover={{
                scale: 1.05,
                rotate: 2
              }} transition={{
                duration: 0.3
              }} data-magicpath-id="59" data-magicpath-path="KyleParksPortfolio.tsx">
                  <SortableContainer dndKitId="dfc8a366-4140-42ae-a916-2659279f2ab9" containerType="regular" prevTag="div" className="w-full h-full bg-white rounded-[22px] overflow-hidden" data-magicpath-id="60" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      <SortableContainer dndKitId="4bd986a2-1d55-4dcc-9dc6-7b251cbe7233" containerType="regular" prevTag="section" id="education" className="py-32 bg-gradient-to-br from-[#EFFFFA] via-white to-[#E5ECF4] relative overflow-hidden" data-magicpath-id="64" data-magicpath-path="KyleParksPortfolio.tsx">
        <FloatingOrb delay={0} duration={25} size="medium" color="#C3BEF0" data-magicpath-id="65" data-magicpath-path="KyleParksPortfolio.tsx" />

        <SortableContainer dndKitId="7c039ba4-ac8d-4049-b674-7d27ea1e4171" containerType="regular" prevTag="div" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" data-magicpath-id="66" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="c0eca306-e126-4668-8bf7-a25ac0e408d4" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="b37a4fc6-e196-4c98-b82a-4cec7e5e0945" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-20" initial={{
            opacity: 0,
            x: -100
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="15fc4ac9-51a3-4d47-b1cf-7958fc60cbdd" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.3
            }} transition={{
              duration: 0.6
            ...
            <SortableContainer dndKitId="131b556f-abf1-4153-9c06-446922fa3bae" containerType="collection" prevTag="div" className="space-y-8" data-magicpath-id="72" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      <SortableContainer dndKitId="ed64f698-637a-4932-82ec-f77e40bbd1c3" containerType="regular" prevTag="section" id="skills" className="py-32 bg-white" data-magicpath-id="79" data-magicpath-path="KyleParksPortfolio.tsx">
        <SortableContainer dndKitId="b8a5bb9f-03e2-4483-a5c0-1a1d6e2ecc74" containerType="regular" prevTag="div" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8" data-magicpath-id="80" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="c0db67b8-4cea-45fd-b0cd-04ff0ff28bbe" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="90098d3f-5a7b-48ac-92a3-010a8b2fe21f" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-20" initial={{
            opacity: 0,
            x: -100
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="429f501b-3ce0-4cd6-aff8-d3b9d504c1fc" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.3
            }} transition={{
              duration: 0.6
            ...
            <SortableContainer dndKitId="7a97f0a8-5a09-446c-9c0a-aa4fec998743" containerType="collection" prevTag="div" className="grid md:grid-cols-2 lg:grid-cols-4 gap-6" data-magicpath-id="86" data-magicpath-path="KyleParksPortfolio.tsx">
              ...
              rotate: 2
                ...
                scale: 1.08
                    ...
                    <Zap size={22} className="group-hover:text-[#C3BEF0] transition-colors" data-magicpath-uuid={(skillGroup as any)["mpid"] ?? "unsafe"} data-magicpath-id="89" data-magicpath-path="KyleParksPortfolio.tsx" />
                    {skillGroup.category}
                  </motion.h3>
                  <ul className="space-y-3" data-magicpath-uuid={(skillGroup as any)["mpid"] ?? "unsafe"} data-magicpath-id="90" data-magicpath-path="KyleParksPortfolio.tsx">
      ...
      <SortableContainer dndKitId="34a448b4-381f-419e-9a20-2e28f1419f9b" containerType="regular" prevTag="section" id="projects" className="py-32 bg-gradient-to-br from-[#E5ECF4] via-white to-[#EFFFFA] relative overflow-hidden" data-magicpath-id="93" data-magicpath-path="KyleParksPortfolio.tsx">
        <FloatingOrb delay={5} duration={25} size="large" color="#8A4FFF" data-magicpath-id="94" data-magicpath-path="KyleParksPortfolio.tsx" />

        <SortableContainer dndKitId="4c7013d0-0a76-46e0-a1a5-0e256c4bdcb1" containerType="regular" prevTag="div" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" data-magicpath-id="95" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="36277ad0-043a-4b74-906c-21fb00436c5e" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0
        }} whileInView={{
          opacity: 1
        }} transition={{
          ...
          margin: '-100px'
            ...
            <SortableContainer dndKitId="06add68f-5d31-4bb8-9d1e-05bd7dad4afb" containerType="regular" prevTag="motion.div" className="flex items-center gap-4 mb-20" initial={{
            opacity: 0,
            x: -100
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              <SortableContainer dndKitId="0550f3b0-30aa-4aae-8b66-cc1b107c16fc" containerType="regular" prevTag="motion.div" whileHover={{
              rotate: 360,
              scale: 1.3
            }} transition={{
              duration: 0.6
            }} className="p-3 rounded-2xl bg-gradient-to-br from-[#8A4FFF] to-[#C3BEF0] shadow-lg shadow-[#8A4FFF]/20" data-magicpath-id="98" data-magicpath-path="KyleParksPortfolio.tsx">
                <Briefcase size={32} className="text-white" data-magicpath-id="99" data-magicpath-path="KyleParksPortfolio.tsx" />
              </SortableContainer>
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900" data-magicpath-id="100" data-magicpath-path="KyleParksPortfolio.tsx">Projects</h2>
            </SortableContainer>

            <SortableContainer dndKitId="ce890697-017d-4645-b4a5-29111706624b" containerType="collection" prevTag="div" className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16" data-magicpath-id="101" data-magicpath-path="KyleParksPortfolio.tsx">
              ...
              scale: 1.05,
              rotate: 2
            }} className="bg-white rounded-3xl p-8 hover:shadow-2xl transition-all duration-200 cursor-pointer border border-transparent hover:border-[#8A4FFF]/20 group relative overflow-hidden" data-magicpath-uuid={(project as any)["mpid"] ?? "unsafe"} data-magicpath-id="102" data-magicpath-path="KyleParksPortfolio.tsx">
                ...
                scale: 1.05
              }} data-magicpath-uuid={(project as any)["mpid"] ?? "unsafe"} data-magicpath-field="title:unknown" data-magicpath-id="103" data-magicpath-path="KyleParksPortfolio.tsx">
                    {project.title}
                  </motion.h3>
                  <p className="text-gray-600 mb-6 leading-relaxed" data-magicpath-uuid={(project as any)["mpid"] ?? "unsafe"} data-magicpath-field="description:unknown" data-magicpath-id="104" data-magicpath-path="KyleParksPortfolio.tsx">{project.description}</p>
                  <div className="flex flex-wrap gap-2 mb-6" data-magicpath-uuid={(project as any)["mpid"] ?? "unsafe"} data-magicpath-id="105" data-magicpath-path="KyleParksPortfolio.tsx">
                ...
                x: 10
                  ...
                  repeat: Infinity
                      ...
                      <ExternalLink size={20} data-magicpath-uuid={(project as any)["mpid"] ?? "unsafe"} data-magicpath-id="109" data-magicpath-path="KyleParksPortfolio.tsx" />
                    </motion.span>
                  </motion.a>
                </motion.div>)}
            </SortableContainer>

            <SortableContainer dndKitId="cb0642d3-c15e-41bf-9d6d-b282c791b38a" containerType="regular" prevTag="motion.div" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            once: true
          }} className="flex justify-center" data-magicpath-id="110" data-magicpath-path="KyleParksPortfolio.tsx">
              ...
              scale: 0.95
            }} className="inline-flex items-center gap-3 px-12 py-6 bg-white text-[#8A4FFF] rounded-2xl font-bold hover:shadow-2xl transition-all duration-300 border-2 border-[#8A4FFF] hover:bg-[#8A4FFF] hover:text-white group" data-magicpath-id="111" data-magicpath-path="KyleParksPortfolio.tsx">
                <motion.span data-magicpath-motion-tag="motion.span" whileHover={{
                rotate: 360
              }} transition={{
                duration: 0.5
              }} data-magicpath-id="112" data-magicpath-path="KyleParksPortfolio.tsx">
                  <Github size={26} data-magicpath-id="113" data-magicpath-path="KyleParksPortfolio.tsx" />
                </motion.span>
                View More Projects
                <motion.span data-magicpath-motion-tag="motion.span" className="transition-transform duration-300 group-hover:translate-x-2" data-magicpath-id="114" data-magicpath-path="KyleParksPortfolio.tsx">
                  <ExternalLink size={24} data-magicpath-id="115" data-magicpath-path="KyleParksPortfolio.tsx" />
                </motion.span>
              </motion.a>
            </SortableContainer>
          </SortableContainer>
      ...
      <SortableContainer dndKitId="4f8ed867-2f55-41d8-8845-f2bb714d0110" containerType="regular" prevTag="section" id="contact" className="py-32 bg-gradient-to-br from-[#8A4FFF] via-[#9D5FFF] to-[#C3BEF0] relative overflow-hidden" data-magicpath-id="116" data-magicpath-path="KyleParksPortfolio.tsx">
        <FloatingOrb delay={0} duration={20} size="large" color="#FFFFFF" data-magicpath-id="117" data-magicpath-path="KyleParksPortfolio.tsx" />

        <SortableContainer dndKitId="f3eeaefe-e815-4776-936d-1888a2d4ea35" containerType="regular" prevTag="div" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10" data-magicpath-id="118" data-magicpath-path="KyleParksPortfolio.tsx">
          <SortableContainer dndKitId="b10cbb84-bb87-47f2-a4c8-3ec953a6b083" containerType="regular" prevTag="motion.div" initial={{
          opacity: 0,
          y: 80
        }} whileInView={{
          opacity: 1,
          ...
          once: true
            ...
            <SortableContainer dndKitId="9cc3c640-27f2-44ff-9c42-815a8a0f0cba" containerType="regular" prevTag="motion.div" className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-20" initial={{
            opacity: 0,
            y: 30
          }} whileInView={{
            opacity: 1,
            ...
            once: true
              ...
              scale: 0.95
            }} className="px-12 py-6 bg-white text-[#8A4FFF] rounded-2xl font-bold hover:shadow-2xl transition-all duration-200 flex items-center gap-3 shadow-xl" data-magicpath-id="123" data-magicpath-path="KyleParksPortfolio.tsx">
                <Mail size={24} data-magicpath-id="124" data-magicpath-path="KyleParksPortfolio.tsx" />
                Send Email
              </motion.a>
              ...
              scale: 0.95
            }} className="px-12 py-6 bg-white/10 backdrop-blur-sm text-white rounded-2xl font-bold hover:bg-white/20 transition-all duration-200 flex items-center gap-3 border-2 border-white/30 hover:border-white/50 shadow-xl" data-magicpath-id="125" data-magicpath-path="KyleParksPortfolio.tsx">
                <Linkedin size={24} data-magicpath-id="126" data-magicpath-path="KyleParksPortfolio.tsx" />
                Connect on LinkedIn
              </motion.a>
            </SortableContainer>

            {/* Footer content */}
            <SortableContainer dndKitId="10f51803-d6b3-4198-89b8-e7976bd3791b" containerType="regular" prevTag="motion.div" className="pt-10 border-t border-white/20" initial={{
            opacity: 0
          }} whileInView={{
            opacity: 1
          }} transition={{
            ...
            once: true
              ...
              <SortableContainer dndKitId="0ee31142-1489-42df-a247-7fdebec435f6" containerType="regular" prevTag="div" className="flex flex-col md:flex-row items-center justify-between gap-6" data-magicpath-id="128" data-magicpath-path="KyleParksPortfolio.tsx">
                <p className="text-white/90 text-base font-medium" data-magicpath-id="129" data-magicpath-path="KyleParksPortfolio.tsx">
                  © 2024 Kyle Parks. Built with React, TypeScript, and Tailwind CSS.
                </p>
                <SortableContainer dndKitId="fb3feb8f-0404-4ad3-bdbe-ffb3003590dc" containerType="collection" prevTag="div" className="flex items-center gap-5" data-magicpath-id="130" data-magicpath-path="KyleParksPortfolio.tsx">
                  {[{
                  icon: Github,
                  href: 'https://github.com',
                  label: 'GitHub',
                  mpid: "d5d05245-dcfc-4fc1-a08c-e0c32dd1d697"
                }, {
                  icon: Linkedin,
                  href: 'https://linkedin.com',
                  label: 'LinkedIn',
                  mpid: "2d582011-b4e5-46ab-9c30-6e4a0f7f06f5"
                }, {
                  icon: Mail,
                  href: 'mailto:kyle@example.com',
                  label: 'Email',
                  mpid: "a05e532a-e734-46a8-8128-c317f14bb48e"
                }].map(({
                  icon: Icon,
                  href,
                  label
                  ...
                  y: -5,
                  rotate: 10
                }} className="text-white/80 hover:text-white transition-colors" aria-label={label} data-magicpath-id="131" data-magicpath-path="KyleParksPortfolio.tsx">
                      <Icon size={24} data-magicpath-id="132" data-magicpath-path="KyleParksPortfolio.tsx" />
                    </motion.a>)}
                </SortableContainer>
              </SortableContainer>
            </SortableContainer>
